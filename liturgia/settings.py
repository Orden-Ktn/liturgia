...
WSGI_APPLICATION = 'liturgia.wsgi.application'
...
TIME_ZONE = 'Africa/Porto-Novo'  # Bénin (UTC+1)
...
from .secret_settings import LEEKPAY_PUBLIC_KEY, LEEKPAY_SECRET_KEY
